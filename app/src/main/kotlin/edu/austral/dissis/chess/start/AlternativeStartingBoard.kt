...
class AlternativeStartingBoard(private val classicPieceFactory: PieceFactory) : StartingBoardGenerator {
    ...
    override fun generate(): Board {
        return ClassicBoard(8, 8, mapOf(
            Pair(Position(1, 1), classicPieceFactory.createPiece(PieceType.PAWN, Color.BLACK)),
            Pair(Position(2, 1), classicPieceFactory.createPiece(PieceType.PAWN, Color.BLACK)),
            Pair(Position(3, 1), classicPieceFactory.createPiece(PieceType.PAWN, Color.BLACK)),
            Pair(Position(4, 1), classicPieceFactory.createPiece(PieceType.PAWN, Color.BLACK)),
            Pair(Position(5, 1), classicPieceFactory.createPiece(PieceType.PAWN, Color.BLACK)),
            Pair(Position(6, 1), classicPieceFactory.createPiece(PieceType.PAWN, Color.BLACK)),
            Pair(Position(7, 1), classicPieceFactory.createPiece(PieceType.PAWN, Color.BLACK)),
            Pair(Position(8, 1), classicPieceFactory.createPiece(PieceType.PAWN, Color.BLACK)),
            ...
            Pair(Position(1, 8), classicPieceFactory.createPiece(PieceType.PAWN, Color.WHITE)),
            Pair(Position(2, 8), classicPieceFactory.createPiece(PieceType.PAWN, Color.WHITE)),
            Pair(Position(3, 8), classicPieceFactory.createPiece(PieceType.PAWN, Color.WHITE)),
            Pair(Position(4, 8), classicPieceFactory.createPiece(PieceType.PAWN, Color.WHITE)),
            Pair(Position(5, 8), classicPieceFactory.createPiece(PieceType.PAWN, Color.WHITE)),
            Pair(Position(6, 8), classicPieceFactory.createPiece(PieceType.PAWN, Color.WHITE)),
            Pair(Position(7, 8), classicPieceFactory.createPiece(PieceType.PAWN, Color.WHITE)),

            Pair(Position(8, 8), classicPieceFactory.createPiece(PieceType.PAWN, Color.WHITE)),
